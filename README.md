...
[![GoDoc](https://godoc.org/github.com/EvanOman/gopy?status.svg)](https://godoc.org/github.com/EvanOman/gopy)
[![CI](https://github.com/EvanOman/gopy/workflows/CI/badge.svg)](https://github.com/EvanOman/gopy/actions)
...
$ go install github.com/EvanOman/gopy@latest
```
...
See the [CONTRIBUTING](https://github.com/EvanOman/gopy/blob/master/CONTRIBUTE.md) guide for pointers on how to contribute to `gopy`.
...
Documentation is available on [godoc](https://godoc.org):
 https://godoc.org/github.com/EvanOman/gopy
...
ex:
 ...
 $ gopy pkg github.com/EvanOman/gopy/_examples/hi
...
Options:
  ...
  -url="https://github.com/EvanOman/gopy": home page for project
...
ex:
 ...
 $ gopy exe github.com/EvanOman/gopy/_examples/hi
...
ex:
 ...
 $ gopy gen github.com/EvanOman/gopy/_examples/hi
...
ex:
 ...
 $ gopy build github.com/EvanOman/gopy/_examples/hi
...
$ go get github.com/EvanOman/gopy/_examples/hi
$ gopy build -output=out -vm=python3 github.com/EvanOman/gopy/_examples/hi
$ ls out
...
```python
>>> import gopy
>>> hi = gopy.load("github.com/EvanOman/gopy/_examples/hi")
gopy> inferring package name...
gopy> loading 'github.com/EvanOman/gopy/_examples/hi'...
gopy> importing 'github.com/EvanOman/gopy/_examples/hi'

>>> print hi
<module 'github.com/EvanOman/gopy/_examples/hi' from '/some/path/.../hi.so'>
...
```
$ cd github.com/EvanOman/gopy/_examples/hi
...
```
$ cd $GOPATH/src/github.com/EvanOman/gopy
...
[Support matrix ](https://github.com/EvanOman/gopy/blob/master/SUPPORT_MATRIX.md).
